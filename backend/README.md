...
## Project Structure
    ...
    ├── testapiautostorybo_112279  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112279`
...
2. Clone this repo and `cd testapiautostorybo_112279`
